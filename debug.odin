...
lookup :: proc(ins: [3]u8, cpu: ^CPU) -> (op: string) {
	...
	case 0x00:
		return "NOP"
	case 0x01:
		return fmt.aprintf("LD BC, %4x", concat(ins[1], ins[2]))
	case 0x02:
		return "LD (BC), A"
	case 0x03:
		return "INC BC"
	...
	case 0x0D:
		return "DEC C"
	case 0x0E:
		return fmt.aprintf("LD C, %2x", ins[1])
	case 0x0F:
		return "RRCA"

	case 0x11:
		return fmt.aprintf("LD DE, %4x", concat(ins[1], ins[2]))
	case 0x12:
		return "LD (DE), A"
	case 0x13:
		return "INC DE"
	case 0x16:
		return fmt.aprintf("LD D, %2x", ins[1])
	case 0x19:
		return "ADD HL, DE"
	case 0x1A:
		return "LD A, (DE)"
	...
	case 0x21:
		return fmt.aprintf("LD HL, %4x", concat(ins[1], ins[2]))
	case 0x22:
		return "LD (HL+), A"
	case 0x23:
		return "INC HL"
	...
	case 0x38:
		return fmt.aprintf("JR C, %2x", ins[1])
	case 0x39:
		return "ADD HL,SP"
	case 0x3A:
		return "LD A,(HL-)"
	case 0x3B:
		return "DEC SP"
	case 0x3E:
		return fmt.aprintf("LD A, %2x", ins[1])
	...
	case 0xC1:
		return "POP BC"
	case 0xC3:
		return fmt.aprintf("JP %4x", concat(ins[1], ins[2]))
	case 0xC4:
		return fmt.aprintf("CALL NZ, %4x", concat(ins[1], ins[2]))
	case 0xC5:
		return "PUSH BC"
	case 0xC9:
		return "RET"
	case 0xCA:
		return "RET NZ"
	case 0xCB:
		return fmt.aprintf("CB %2x", ins[1])
	case 0xCD:
		return fmt.aprintf("CALL %4x", concat(ins[1], ins[2]))
	...
	case 0xD5:
		return "PUSH DE"
	case 0xD6:
		return fmt.aprintf("SUB A, %2x", ins[1])
	case 0xDA:
		return "RET NC"

	case 0xE0:
		return fmt.aprintf("LDH (FF00+%2x), a", ins[1])
	case 0xE1:
		return "POP HL"
	case 0xE5:
		return "PUSH HL"
	...
	case 0xF0:
		return fmt.aprintf("LDH a, (FF00+%2x)", ins[1])
	case 0xF1:
		return "POP AF"
	case 0xF3:
		return "DI"
	case 0xf5:
		return "PUSH AF"
	case 0xF8:
		return fmt.aprintf("LD HL, SP+%2x", ins[1])
	case 0xFB:
		return "EI"
	case 0xFE:
		return fmt.aprintf("CP A, %2x", ins[1])
	case:
		return "UNKNOWN"
	}
}
